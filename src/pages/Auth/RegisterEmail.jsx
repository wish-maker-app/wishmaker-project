...
export default function RegisterEmail() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#5B6BF5]">
      ...
      >
        <h1 className="text-white font-bold text-3xl text-center">Créer un compte</h1>
        <p className="text-white/80 text-sm text-center">Créer vos vœux ou réaliser en !</p>
      </motion.div>
      ...
      <motion.div
        ...
        className="flex-1 bg-white px-6 pt-8 pb-10 flex flex-col gap-5"
        style={{ borderRadius: '32px 32px 0 0' }}
      >
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <Input label="Email" type="email" placeholder="Entrez votre adresse e-mail"
