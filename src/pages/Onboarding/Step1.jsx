  ...
  return (
    <div className="fixed inset-0 bg-white flex items-center justify-center">
      <div className="w-full max-w-[430px] h-[100dvh] flex flex-col overflow-hidden"
        style={{ background: 'linear-gradient(180deg, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.15) 25%, rgba(0,0,0,0) 40%, rgba(0,0,0,0.15) 55%, rgba(0,0,0,0.5) 72%, rgba(0,0,0,0.9) 85%, rgba(0,0,0,1) 100%)', backgroundColor: '#fff', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
