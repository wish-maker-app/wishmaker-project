    ...
    <div className="h-screen bg-[#F7F7FA] flex flex-col overflow-y-auto" style={{ paddingBottom: 90 }}>
      ...
      {userData && (
        ...
        >
          ...
          <div className="w-px bg-[#EDEDF2]" />
          <div className="text-center">
            <div className="text-[22px] font-bold text-[#1A1A2E] flex items-center justify-center gap-1">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="#F5C542" aria-hidden="true">
